...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: "Consolas", "Courier New", monospace; max-width: 820px; margin: 0 auto; padding: 16px; background: linear-gradient(135deg, #0284C7 0%, #0369A1 100%); color: #F0F9FF !important; line-height: 1.45; font-size: 15px; min-height: 100vh; }
        ...
        .header p { color: #7DD3FC !important; font-size: 0.95em; }
        .section { background: linear-gradient(180deg, rgba(15, 52, 96, 0.98) 0%, rgba(8, 47, 73, 0.98) 100%); padding: 15px 18px; margin: 14px 0; border-radius: 9px; border: 1px solid rgba(34, 211, 238, 0.35); }
        ...
        td { padding: 10px 7px; color: #E0F2FE !important; border-bottom: 1px solid rgba(34, 211, 238, 0.15); }
        td:first-child { font-weight: 600; color: #7DD3FC !important; }
        td:last-child { text-align: right; }
        .value-box { background: linear-gradient(135deg, rgba(21, 94, 117, 0.95) 0%, rgba(15, 52, 96, 0.95) 100%); padding: 6px 12px; border-radius: 6px; border: 1px solid rgba(34, 211, 238, 0.4); display: inline-block; color: #67E8F9 !important; font-weight: bold; }
        .summary-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin: 12px 0 16px 0; }
        .summary-card { background: linear-gradient(180deg, rgba(21, 94, 117, 0.95) 0%, rgba(15, 52, 96, 0.95) 100%); padding: 18px 12px; border-radius: 8px; text-align: center; border: 2px solid rgba(34, 211, 238, 0.4); }
        .summary-card .label { color: #22D3EE !important; font-size: 1.1em; font-weight: 600; margin-bottom: 10px; }
        .summary-card .value { color: #67E8F9 !important; font-size: 1.4em; font-weight: bold; }
...
<body>
    <div class="header"><h1>🐟 AQUACALC LOG</h1><p>${now}</p></div>
    <div class="section"><h2>ЖЕЛАЕМЫЕ ПАРАМЕТРЫ</h2><table>
    ...
    <div class="section"><h2>НЕОБХОДИМО ВНЕСТИ</h2><table>
    ...
    <div class="section"><h2>РЕЗУЛЬТАТЫ РАСЧЁТА</h2><div class="summary-grid">
        <div class="summary-card"><div class="label">TDS</div><div class="value">${getVal('Label_TDC')}</div></div>
        <div class="summary-card"><div class="label">TH (CaCO₃)</div><div class="value">${getVal('Label_TH_CaCO3')}</div></div>
        <div class="summary-card"><div class="label">KH</div><div class="value">${getVal('Label_KH')}</div></div>
    </div></div>
    <div class="section"><h2>ИОННЫЙ СОСТАВ ВОДЫ</h2><table>
    ...
    <div class="footer"><p>PlecoHobby © ${new Date().getFullYear()}</p><p>Профессионализм в каждой капле.</p></div>
</body>
</html>`;
